...
const checks = [
  ...
  [html.includes('theme.css?v=4') && html.includes('styles.css?v=45') && privacy.includes('styles.css?v=39'), "continuous background theme assets are cache-busted"],
  ...
  [packageJson.dependencies?.three === "0.185.1" && threeRuntimePresent && html.includes('id="universe-render"') && html.includes('type="module" src="three-universe.js?v=12"') && universe.includes('from "./vendor/three.module.min.js"'), "pinned, locally hosted Three.js runtime powers the 3D universe"],
  ...
  [universe.includes('stage.dataset.threeInteraction = "orbit-zoom-select"') && universe.includes('addEventListener("pointerdown"') && universe.includes('addEventListener("wheel"') && universe.includes('addEventListener("dblclick"') && universe.includes('addEventListener("keydown"') && universe.includes("targetRotationY") && universe.includes("targetZoom") && html.includes('tabindex="0"') && html.includes('role="application"'), "3D scene supports drag orbit, wheel and keyboard zoom, reset, hover, and raycast selection"],
