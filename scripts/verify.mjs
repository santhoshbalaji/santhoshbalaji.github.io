...
const checks = [
  ...
  [packageJson.dependencies?.three === "0.185.1" && threeRuntimePresent && html.includes('id="universe-render"') && html.includes('id="universe-activate"') && script.includes('import("./three-universe.js?v=35")') && script.includes("activateThreeUniverse") && !script.includes("requestIdleCallback") && universe.includes('from "./vendor/three.module.min.js"'), "pinned, locally hosted Three.js powers the orrery only after explicit 3D activation"],
  ...
  [html.includes('script.min.js?v=2'), "minified round-robin interaction script is cache-busted"],
  [productionCss.length < css.length && productionTheme.length < theme.length && productionScript.length < script.length && productionScript.includes("three-universe.js?v=35"), "production CSS, theme, and interaction bundles are minified from their readable sources"],
