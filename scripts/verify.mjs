...
const checks = [
  ...
  [html.includes('theme.css?v=4') && html.includes('styles.css?v=49') && privacy.includes('styles.css?v=39'), "continuous background theme assets are cache-busted"],
